...
export default function RefAwarePopup({
  ...
  return createPortal(
    <div
      role="listbox"
      className="fixed z-[var(--z-popover)] max-h-[280px] w-[260px] overflow-y-auto rounded-md border border-border-default bg-surface-1 shadow-[var(--shadow-popover)] text-xs animate-fade-in"
      style={{
