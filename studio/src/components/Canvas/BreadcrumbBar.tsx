...
export default function BreadcrumbBar() {
  ...
  return (
    <div className="absolute top-2 left-1/2 -translate-x-1/2 z-[var(--z-canvas)] flex items-center gap-1 bg-surface-0/90 border border-border-default rounded-lg px-3 py-1.5 shadow-[var(--shadow-popover)] backdrop-blur-sm">
      {/* Back button */}
      <button
