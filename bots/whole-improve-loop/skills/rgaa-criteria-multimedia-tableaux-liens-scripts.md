...
<!-- TODO(skill-dup): this RGAA skill is also shipped in bots/rgaa-audit/skills/rgaa-criteria-multimedia-tableaux-liens-scripts.md — iterion has no skill-sharing primitive yet, keep the copies in sync. -->
