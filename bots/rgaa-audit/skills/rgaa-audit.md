...
<!-- TODO(skill-dup): this RGAA skill is also shipped in bots/whole-improve-loop/skills/rgaa-audit.md — iterion has no skill-sharing primitive yet, keep the copies in sync. -->
