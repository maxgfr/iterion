...
This installs the [`SKILL.md`](SKILL.md) reference and supporting files into your agent's skill directory (e.g., `~/.claude/skills/iterion-dsl/` for Claude Code, `~/.codex/skills/iterion-dsl/` for Codex).
...
| [`references/dsl-grammar.md`](references/dsl-grammar.md) | Formal grammar specification (updated EBNF) |
